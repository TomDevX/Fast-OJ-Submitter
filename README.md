...
> You need to download [Tampermonkey](https://www.tampermonkey.net/) or similar tools to be able to use this script
...
If you want to improve the code or request a feature, feel free to [open an issue](https://github.com/TomDevX/Fast-OJ-Submitter/issues/new/choose).
